...
class ResponseAssertionsTest extends FunSuite {
  ...
  test("validateContent - response time is below - limit is integer string") {
    val responseAction = ResponseAction(group = ResponseActionGroupType.ASSERT, name = AssertionResponseAction.RESPONSE_TIME_IS_BELOW, Map("limit" -> "200"))
  ...
  test("validateContent - response time is below - limit is not integer string") {
    val responseAction = ResponseAction(group = ResponseActionGroupType.ASSERT, name = AssertionResponseAction.RESPONSE_TIME_IS_BELOW, Map("limit" -> "not_integer"))
  ...
  test("validateContent - response time is above - limit is integer string") {
    val responseAction = ResponseAction(group = ResponseActionGroupType.ASSERT, name = AssertionResponseAction.RESPONSE_TIME_IS_ABOVE, Map("limit" -> "200"))
    AssertionResponseAction.validateContent(responseAction)
  }

  test("validateContent - response time is above - limit is not integer string") {
    val responseAction = ResponseAction(group = ResponseActionGroupType.ASSERT, name = AssertionResponseAction.RESPONSE_TIME_IS_ABOVE, Map("limit" -> "not_integer"))
  ...
  test("validateContent - response time is above - missing limit parameter") {
    val responseAction = ResponseAction(group = ResponseActionGroupType.ASSERT, name = AssertionResponseAction.RESPONSE_TIME_IS_ABOVE, Map.empty)
  ...
  test("validateContent - valid status code string") {
    val responseAction = ResponseAction(group = ResponseActionGroupType.ASSERT, name = AssertionResponseAction.STATUS_CODE_EQUALS, Map("code" -> "200"))
    AssertionResponseAction.validateContent(responseAction)
  }

  test("validateContent - invalid status code string") {
    intercept[ContentValidationFailedException] {
      AssertionResponseAction.validateContent(ResponseAction(group = ResponseActionGroupType.ASSERT, name = AssertionResponseAction.STATUS_CODE_EQUALS, Map("code" -> "not an integer")))
    }
  }

  test("validateContent - status code equals - missing code parameter") {
    val responseAction = ResponseAction(group = ResponseActionGroupType.ASSERT, name = AssertionResponseAction.STATUS_CODE_EQUALS, Map.empty)
  ...
  test("validateContent - header exists - valid header name string") {
    val responseAction = ResponseAction(group = ResponseActionGroupType.ASSERT, name = AssertionResponseAction.HEADER_EXISTS, Map("headerName" -> "content-type"))
    AssertionResponseAction.validateContent(responseAction)
  }

  test("validateContent - header exists - invalid header name string") {
    val responseAction = ResponseAction(group = ResponseActionGroupType.ASSERT, name = AssertionResponseAction.HEADER_EXISTS, Map("headerName" -> ""))
  ...
  test("validateContent - header exists - missing header name parameter") {
    val responseAction = ResponseAction(group = ResponseActionGroupType.ASSERT, name = AssertionResponseAction.HEADER_EXISTS, Map.empty)
  ...
  test("validateContent - header value equals - valid header name and value strings") {
    val responseAction = ResponseAction(group = ResponseActionGroupType.ASSERT, name = AssertionResponseAction.HEADER_VALUE_EQUALS, Map("headerName" -> "Content-Type", "expectedValue" -> "application/json"))
    AssertionResponseAction.validateContent(responseAction)
  }

  test("validateContent - header value equals - invalid header name string") {
    val responseAction = ResponseAction(group = ResponseActionGroupType.ASSERT, name = AssertionResponseAction.HEADER_VALUE_EQUALS, Map("headerName" -> "", "expectedValue" -> "application/json"))
  ...
  test("validateContent - header value equals - invalid expected value string") {
    val responseAction = ResponseAction(group = ResponseActionGroupType.ASSERT, name = AssertionResponseAction.HEADER_VALUE_EQUALS, Map("headerName" -> "Content-Type", "expectedValue" -> ""))
  ...
  test("validateContent - header value equals - missing header name string") {
    val responseAction = ResponseAction(group = ResponseActionGroupType.ASSERT, name = AssertionResponseAction.HEADER_VALUE_EQUALS, Map("expectedValue" -> "application/json"))
  ...
  test("validateContent - header value equals - missing header value string") {
    val responseAction = ResponseAction(group = ResponseActionGroupType.ASSERT, name = AssertionResponseAction.HEADER_VALUE_EQUALS, Map("headerName" -> "Content-Type"))
  ...
  test("validateContent - cookie exists - valid cookie name string") {
    val responseAction = ResponseAction(group = ResponseActionGroupType.ASSERT, name = AssertionResponseAction.COOKIE_EXISTS, Map("cookieName" -> "testCookie"))
    AssertionResponseAction.validateContent(responseAction)
  }

  test("validateContent - cookie exists - invalid cookie name string") {
    val responseAction = ResponseAction(group = ResponseActionGroupType.ASSERT, name = AssertionResponseAction.COOKIE_EXISTS, Map("cookieName" -> ""))
  ...
  test("validateContent - cookie exists - missing cookie name parameter") {
    val responseAction = ResponseAction(group = ResponseActionGroupType.ASSERT, name = AssertionResponseAction.COOKIE_EXISTS, Map())
  ...
  test("validateContent - cookie value equals - valid cookie name and value strings") {
    val responseAction = ResponseAction(group = ResponseActionGroupType.ASSERT, name = AssertionResponseAction.COOKIE_VALUE_EQUALS, Map("cookieName" -> "testCookie", "expectedValue" -> "cookieValue"))
    AssertionResponseAction.validateContent(responseAction)
  }

  test("validateContent - cookie value equals - invalid cookie name string") {
    val responseAction = ResponseAction(group = ResponseActionGroupType.ASSERT, name = AssertionResponseAction.COOKIE_VALUE_EQUALS, Map("cookieName" -> "", "expectedValue" -> "cookieValue"))
  ...
  test("validateContent - cookie value equals - invalid cookie value string") {
    val responseAction = ResponseAction(group = ResponseActionGroupType.ASSERT, name = AssertionResponseAction.COOKIE_VALUE_EQUALS, Map("cookieName" -> "testCookie", "expectedValue" -> ""))
  ...
  test("validateContent - cookie value equals - missing cookie name string") {
    val responseAction = ResponseAction(group = ResponseActionGroupType.ASSERT, name = AssertionResponseAction.COOKIE_VALUE_EQUALS, Map("expectedValue" -> "cookieValue"))
  ...
  test("validateContent - cookie value equals - missing cookie value string") {
    val responseAction = ResponseAction(group = ResponseActionGroupType.ASSERT, name = AssertionResponseAction.COOKIE_VALUE_EQUALS, Map("cookieName" -> "testCookie"))
  ...
  test("validateContent - body contains text - body is not empty") {
    val responseAction = ResponseAction(group = ResponseActionGroupType.ASSERT, name = AssertionResponseAction.BODY_CONTAINS_TEXT, Map("text" -> "test content"))
    AssertionResponseAction.validateContent(responseAction)
  }

  test("validateContent - body contains text - body is empty") {
    intercept[ContentValidationFailedException] {
      AssertionResponseAction.validateContent(ResponseAction(group = ResponseActionGroupType.ASSERT, name = AssertionResponseAction.BODY_CONTAINS_TEXT, Map("text" -> "")))
    }
  }
  ...
  test("validateContent - body contains text - body parameter is missing") {
    interceptMessage[IllegalArgumentException]("Missing required 'text' parameter for assertion body-contains-text logic.") {
      AssertionResponseAction.validateContent(ResponseAction(group = ResponseActionGroupType.ASSERT, name = AssertionResponseAction.BODY_CONTAINS_TEXT, Map.empty))
    }
  }
  ...
  test("performAssertions - response time is below limit - success") {
    val statusCodeResponseAction = ResponseAction(group = ResponseActionGroupType.ASSERT, name = AssertionResponseAction.RESPONSE_TIME_IS_BELOW, Map("limit" -> "100"))
  ...
  test("performAssertions - response time is above limit - success") {
    val statusCodeResponseAction = ResponseAction(group = ResponseActionGroupType.ASSERT, name = AssertionResponseAction.RESPONSE_TIME_IS_ABOVE, Map("limit" -> "100"))
    val response = Response(200, "Dummy Body", "", "", Map.empty, Map.empty, 101)
  ...
  test("performAssertions - status code assertion - equals") {
    val statusCodeResponseAction = ResponseAction(group = ResponseActionGroupType.ASSERT, name = AssertionResponseAction.STATUS_CODE_EQUALS, Map("code" -> "200"))
  ...
  test("performAssertions - status code - is success") {
    val statusCodeResponseAction = ResponseAction(group = ResponseActionGroupType.ASSERT, name = AssertionResponseAction.STATUS_CODE_IS_SUCCESS, Map.empty)
  ...
  test("performAssertions - status code - is client error") {
    val statusCodeResponseAction = ResponseAction(group = ResponseActionGroupType.ASSERT, name = AssertionResponseAction.STATUS_CODE_IS_CLIENT_ERROR, Map.empty)
  ...
  test("performAssertions - status code - is server error") {
    val statusCodeResponseAction = ResponseAction(group = ResponseActionGroupType.ASSERT, name = AssertionResponseAction.STATUS_CODE_IS_SERVER_ERROR, Map.empty)
    val response500 = Response(500, "Dummy Body", "", "", Map.empty, Map.empty, 100)
  ...
  test("performAssertions - header exists") {
    val headerExistsResponseAction = ResponseAction(group = ResponseActionGroupType.ASSERT, name = AssertionResponseAction.HEADER_EXISTS, Map("headerName" -> "Content-Type"))
  ...
  test("performAssertions - header does not exists") {
    val headerExistsResponseAction = ResponseAction(group = ResponseActionGroupType.ASSERT, name = AssertionResponseAction.HEADER_EXISTS, Map("headerName" -> "headerValue"))
    val response = Response(200, "Dummy Body", "", "", Map("content-type" -> Seq("application/json")), Map.empty, 100)
  ...
  test("performAssertions - header value is equals") {
    val headerValueEqualsResponseAction = ResponseAction(group = ResponseActionGroupType.ASSERT, name = AssertionResponseAction.HEADER_VALUE_EQUALS, Map("headerName" -> "Content-Type", "expectedValue" -> "application/json"))
    val response = Response(200, "Dummy Body", "", "", Map("content-type" -> Seq("application/json")), Map.empty, 100)
  ...
  test("performAssertions - header value is not equals") {
    val headerValueEqualsResponseAction = ResponseAction(group = ResponseActionGroupType.ASSERT, name = AssertionResponseAction.HEADER_VALUE_EQUALS, Map("headerName" -> "someName", "expectedValue" -> "someValue"))
    val response = Response(200, "Dummy Body", "", "", Map("content-type" -> Seq("application/json")), Map.empty, 100)
  ...
  test("performAssertions - content type is json") {
    val contentTypeIsJsonResponseAction = ResponseAction(group = ResponseActionGroupType.ASSERT, name = AssertionResponseAction.CONTENT_TYPE_IS_JSON, Map.empty)
  ...
  test("performAssertions - content type is xml") {
    val contentTypeIsJsonResponseAction = ResponseAction(group = ResponseActionGroupType.ASSERT, name = AssertionResponseAction.CONTENT_TYPE_IS_XML, Map.empty)
  ...
  test("performAssertions - content type is html") {
    val contentTypeIsJsonResponseAction = ResponseAction(group = ResponseActionGroupType.ASSERT, name = AssertionResponseAction.CONTENT_TYPE_IS_HTML, Map.empty)
  ...
  test("performAssertions - cookie exists") {
    val cookieExistsResponseAction = ResponseAction(group = ResponseActionGroupType.ASSERT, name = AssertionResponseAction.COOKIE_EXISTS, Map("cookieName" -> "testCookie"))
  ...
  test("performAssertions - cookie does not exists") {
    val cookieExistsResponseAction = ResponseAction(group = ResponseActionGroupType.ASSERT, name = AssertionResponseAction.COOKIE_EXISTS, Map("cookieName" -> "anotherCookie"))
    val response = Response(200, "Dummy Body", "", "", Map.empty, Map("testCookie" -> ("", false)), 100)
  ...
  test("performAssertions - cookie value is equals") {
    val cookieValueEqualsResponseAction = ResponseAction(group = ResponseActionGroupType.ASSERT, name = AssertionResponseAction.COOKIE_VALUE_EQUALS, Map("cookieName" -> "testCookie", "expectedValue" -> "cookieValue"))
  ...
  test("performAssertions - cookie is secured") {
    val cookieIsSecuredResponseAction = ResponseAction(group = ResponseActionGroupType.ASSERT, name = AssertionResponseAction.COOKIE_IS_SECURED, Map("cookieName" -> "securedCookie"))
  ...
  test("performAssertions - cookie is secured - cookie does not exist") {
    val cookieIsSecuredResponseAction = ResponseAction(group = ResponseActionGroupType.ASSERT, name = AssertionResponseAction.COOKIE_IS_SECURED, Map("cookieName" -> "testCookie", "expectedValue" -> "cookieValue"))
    val response = Response(200, "Dummy Body", "", "", Map.empty, Map.empty, 100)
  ...
  test("performAssertions - cookie is not secured") {
    val cookieIsNotSecuredResponseAction = ResponseAction(group = ResponseActionGroupType.ASSERT, name = AssertionResponseAction.COOKIE_IS_NOT_SECURED, Map("cookieName" -> "notSecuredCookie"))
  ...
  test("performAssertions - cookie is not secured - cookie does not exist") {
    val cookieIsNotSecuredResponseAction = ResponseAction(group = ResponseActionGroupType.ASSERT, name = AssertionResponseAction.COOKIE_IS_NOT_SECURED, Map("cookieName" -> "testCookie", "expectedValue" -> "cookieValue"))
    val response = Response(200, "Dummy Body", "", "", Map.empty, Map.empty, 100)
  ...
  test("performAssertions - body contains assertion") {
    val bodyContainsTextResponseAction = ResponseAction(group = ResponseActionGroupType.ASSERT, name = AssertionResponseAction.BODY_CONTAINS_TEXT, Map("text" -> "dummy"))
  ...
  test("performAssertions - body does not contains assertion") {
    val bodyContainsTextResponseAction = ResponseAction(group = ResponseActionGroupType.ASSERT, name = AssertionResponseAction.BODY_CONTAINS_TEXT, Map("text" -> "dummies"))
    val response = Response(200, "This is a dummy body", "", "", Map.empty, Map.empty, 100)
